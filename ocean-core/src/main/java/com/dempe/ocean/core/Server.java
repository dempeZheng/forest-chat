...
import com.dempe.ocean.core.config.FilesystemConfig;
import com.dempe.ocean.core.config.IConfig;
import com.dempe.ocean.core.config.MemoryConfig;
import com.dempe.ocean.core.spi.SimpleMessaging;
...
public class Server {
    ...
    public void startServer(IConfig config, List<? > handlers) throws IOException {
        if (handlers == null) {
